...
/// اسم المستخدم المسجَّل في سجل التعديلات حالياً — التطبيق يعتمد دخولاً
/// موحّداً برمز PIN بلا نظام مستخدمين متعدد فعلي بعد (راجع AuthService/
/// SessionService)، فلا يوجد اسم مستخدم حقيقي مميَّز لكل عملية بعد. يُستبدل
/// هذا الثابت تلقائياً بأي قيمة حقيقية فور ربط تسجيل دخول متعدد المستخدمين
/// دون الحاجة لتعديل نقاط التسجيل نفسها.
