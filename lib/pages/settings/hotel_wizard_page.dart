...
///
/// وصول الفنادق/الصلاحيات الدقيقة لكل مستخدم لا تُدار من هنا — راجع
/// الإعدادات ← الأمان ← "المستخدمون والصلاحيات" (UsersPage/AddEditUserPage)
/// وPermissionService لنظام الصلاحيات الفعلي.
