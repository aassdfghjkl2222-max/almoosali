...
class _SettingsPageState extends State<SettingsPage> {
  ...
  /// قسم وضع التدريب: زر واحد ظاهر حسب الحالة الحالية فقط (بدء/إنهاء)،
  /// مرتبط مباشرة بـ TrainingModeController.isActive (تفاعلي، ينعكس فوراً
  /// عبر كل التطبيق بما فيها هذه الصفحة نفسها).
